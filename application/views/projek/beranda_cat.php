...
<body>
  ...
  <div class="container dekstop" style="padding-top:30px">
     <h5 style="text-align: center;padding-bottom:15px;padding-top:15px;background-color:#22a7a7;color:white;font-family:Roboto"><b>Kategori Tukang Cat</b></h5>
     <div class="row">
    <?php  
  foreach ($cat as $baris){ ?>
