      ...
      <div class="container">
          <div class="text-center" data-aos="fade-up" data-aos-delay="400">
           ...
           <div class="col-lg-2"></div>
            ...
            <form method="post" action="<?php echo base_url('projek/patukang/changePassword');?>">
            <h1 class="mb-4" style="color:black;"><b>RESET PASSWORD </b></h1> 
            <h2 style="color:black;">for <?= $this->session->userdata('reset_email');?></h2>
           
            <label style="color:white">Masukkan Password baru </label>
           <input type="Password" class="form-control" required="1" autofocus="1" name="password1" style="border-color:white">
            <label style="color:white">Ulangi Password Anda</label>
           <input type="Password" class="form-control" required="1" name="password2" style="border-color:white"><br>
